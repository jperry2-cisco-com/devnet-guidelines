...
accessible to the running Docker image, and you must pass the pathname
to the labs to the Docker image when you run it.
...
* **/PATH/TO/LABS/DIRECTORY** is the filesystem path to the directory
  ...
  `/Users/developer/Cisco/devnet-guidelines/`; you would then pass that
  same pathname for the value of the -v argument to `docker
  ...
  command instead of the example given here.
